...
resource. Passwordless SSH (`~/.ssh/ha_deploy`) makes it non-interactive, and the bumper
uses plain `ws://` (HA dropped TLS 2026-08-06); `git push` to GitHub is non-interactive
